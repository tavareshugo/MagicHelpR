...
estimates and it standardizes the trait as z-scores (i.e. subtracts the mean trait 
value in the sampled individuals from the estimate and divides by the observed 
